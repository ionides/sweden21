...
\begin{frame}
  ...
  \myemph{Blocked particle filter} (BPF). Independently developed by \citet{rebeschini15} (in theory) and \citet{ng02} (in practice).
...
\item Iterated filtering works well for BPF when parameters are unit-specific, i.e., each city has its own parameters \citep{ning21}.
